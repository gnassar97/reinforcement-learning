...
def test_reward():
    ...
    print(env.agent_loc)
    assert(reward_state_term[0] == -100) 
    assert(reward_state_term[1] == env.state((3, 0))) 
    assert(reward_state_term[2] == False)
    ...
    env.agent_loc = (2, 11)
    reward_state_term = env.env_step(2)
    assert(reward_state_term[0] == -1)
    assert(reward_state_term[1] == env.state((3, 11)))
    assert(reward_state_term[2] == True)
